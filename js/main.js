...
// COMPONENT LINKS
    ...
    document.querySelector('#title').innerHTML += RotateSunUI(1270, -30)
    document.querySelector('#title').innerHTML += TurtleUI(325, 12)
    document.querySelector('#title').innerHTML += TitleUI()
    document.querySelector('#title').innerHTML += WavesUI()
    
    document.querySelector('#intro').innerHTML += SchoolFishUI(300, 100)
    ...
    document.querySelector('#whycare').innerHTML += FishUI(100, 80)
    ...
    document.querySelector('#save').innerHTML += SchoolFish2UI(-50, 90)
    ...
    document.querySelector('#save').innerHTML += SchoolFish3UI(50,90)
    ...
    document.querySelector('#ending').innerHTML += SchoolFish4UI(-10, 80)
