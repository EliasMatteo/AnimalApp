...
// COMPONENT LINKS
    ...
    document.querySelector('#intro').innerHTML += SchoolFishUI(750, 100)
    ...
    document.querySelector('#intro').innerHTML += TextboxUI("230","Hawksbill sea turtles control sponge distribution. ")
    ...
    document.querySelector('#whycare').innerHTML += FishUI(400, 70)
    ...
    document.querySelector('#whycare').innerHTML += TextboxUI("200","They are a food source for many animals. ")
    ...
    document.querySelector('#endanger').innerHTML += Fish2UI(-500, 70)
    ...
    document.querySelector('#endanger').innerHTML += Fish3UI(-450,70)
    ...
    document.querySelector('#bagimgs').innerHTML += recyclingUI()
    document.querySelector('#food').innerHTML += TextboxUI("120","Instead of buying snack-sized food packages,")
    document.querySelector('#food').innerHTML += TextboxUI("120","let’s try to buy bulk food using glass containers.")
    document.querySelector('#foodimgs').innerHTML += mantrashUI()
    document.querySelector('#foodimgs').innerHTML += litterUI()
    
    document.querySelector('#save').innerHTML += SchoolFish2UI(-500, 90)
    ...
    document.querySelector('#save').innerHTML += SchoolFish3UI(-400,90)
    ...
    document.querySelector('#ending').innerHTML += SchoolFish4UI(-550, 80)
    ...
    document.querySelector('#ending').innerHTML += TextboxUI("300","not only for these sea turtles but for all animals, and with this app we can take a step in the right direction. ")
    document.querySelector('#ending').innerHTML += TextboxUI("300","Through a fun and interactive story that will help guide the user & provide a robust learning experience.")
