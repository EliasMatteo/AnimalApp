...
// COMPONENT LINKS
    ...
    document.querySelector('#help').innerHTML += TextboxUI("120","Instead of using plastic bags for shopping,")
    document.querySelector('#help').innerHTML += TextboxUI("120","let’s try to bring a cloth bag every time we go out.")
    document.querySelector('#help').innerHTML += litteringUI()
    document.querySelector('#help').innerHTML += recyclingUI()
    document.querySelector('#help').innerHTML += TextboxUI("120","Instead of buying snack-sized food packages,")
    document.querySelector('#help').innerHTML += TextboxUI("120","let’s try to buy bulk food using glass containers.")
